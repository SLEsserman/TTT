...
- **Remember to link** your `style.css` and `app.js` files to your `index.html` file.

```html
<link rel="stylesheet" type="text/css" href="<your-css-file>" />
<script src="<your-js-file>" defer></script>
```
...
- Pull Request must be submitted utilizing these guidelines: [PR Guidelines](https://github.com/SEI-R-4-24/template_pull_request)
